      ...
      <div style={{display:'grid',gridTemplateColumns:' auto 1fr',width:'100%'}}>
        <div style={{padding:'15px'}}>
          <div style={{ display:'flex',justifyContent:'center',alignItems:'center',width:'100%'}}>
            <a>
              <button><svg width="1.5em" height="1.5em" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor"><path d="M21 12H3m0 0l8.5-8.5M3 12l8.5 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
            </a>
            <div style={{padding:'10px'}}>
              <div>
                <span>Debit settlement</span>
              </div>
            </div>
