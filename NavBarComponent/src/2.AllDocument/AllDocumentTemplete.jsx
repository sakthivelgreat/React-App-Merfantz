...
import './AllDocumentTemplete.css';
import { EnterData } from '../DocumentType/Cards/CardsClickTempletes/DebitSettlementClickEvent/EnterData';


export const AllDocumentTemplete = () => {
  return (
