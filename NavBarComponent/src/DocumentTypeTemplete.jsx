    ...
    <div style={{ display:'flex', flexDirection:'column',alignContent:'center',justifyContent:'center'  }}>
        ...
        <div className='main-navbar' style={{  }} >
          ...
          <div   style={{ display:'flex', justifyContent : 'center',alignItems : 'center' , gap:'20px'}}>
            ...
            <input className='input-search' style={{ padding : ' 2px', border:'none',outline: 'none' , fontSize: '14px' }}  placeholder="Search document type" title="Search (Ctrl + F)" data-hj-allow="true" value=""></input>
            </div>
