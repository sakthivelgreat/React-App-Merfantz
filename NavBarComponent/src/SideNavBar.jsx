...
export const SideNavBar = ({OnClick}) => {
  return (
  <div className='Main-sidebar'>
      <ul>
        <li>
          <a href="#" onClick={()=>OnClick('Documenttypes')}>
        ...
        <li>
          <a href="#" onClick={()=>OnClick('AllDocuments')}>
            <div className='div-svg'>
        ...
        <li>
          <a href="#" onClick={()=>OnClick('AllModels')}>
      ...
      <ul>
        <li>
          <a href="#" onClick={()=>OnClick('GetStarted')} >
        ...
        <li>
          <a href="#"onClick={()=>OnClick('AIModelsHub')}>
        ...
        <li>
          <a href="#"  onClick={()=>OnClick('Settings')}>
